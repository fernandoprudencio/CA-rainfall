...
cb.palette <-
  c(
    #' green scale
    "#122514", "#1b452d", "#176441", "#07874f",
    "#3aa955", "#7dc375", "#aedfa1", "#dcffd5",
    #' yellow scale
    "#9e5c00", "#d48600", "#ecab00", "#f7d700",
    "#fbff0d", "#f4fbae",
    #' red scale
    "#3f0a13", "#770f29", "#a61b28", "#e6b3a1",
    #' white
