...
intrv <- c(seq(-200, -50, 50), seq(-25, 25, 25), seq(50, 150, 50), 250)
intrv.lbl <- c(seq(-200, -50, 50), seq(-25, 25, 25), seq(50, 150, 50), 250)
...
#'   Define plot name
name <- "export/stats/mb_stats.png"
#'   Save plot
