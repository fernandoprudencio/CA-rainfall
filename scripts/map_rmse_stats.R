...
cb.palette <-
  c(
    #' red scale
    "#3f0a13", "#a61b28", "#c75135", "#e6b3a1",
    #' yellow scale
    "#9e5c00", "#ecab00", "#f7d700", "#f4fbae",
    #' green scale
    "#122514",  "#176441", "#3aa955", "#aedfa1"
  )

#'   Define plot name
name <- "export/stats/rmse_stats.png"
#'   Save plot
